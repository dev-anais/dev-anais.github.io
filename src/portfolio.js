...
const greeting = {
  ...
  subTitle: emoji(
    " A front-end developer with over 3 years and 6 months' experience and zest for solving complex problems. I have an experience of building Web and Mobile applications with JavaScript / Reactjs / Redux. And I believe programming can make life easier."
  ),
  resumeLink:
    "https://drive.google.com/file/d/1iUSSTZSgr4mxldvrFDKENi7hwQ67fX78/view?usp=sharing",
...
// Some toy projects you have worked on

const toyProjects = {
  title: "Toy Project",
  subtitle: "A PROJECT MADE FOR STUDY AND FUN",
  projects: [
    {
      ...
      footerLink: [
        {
          name: "Visit Website",
          url: "https://lily-covid-board.herokuapp.com/",
        },
